...
public class ProductDetail implements SuperEntity{
    ...
    public ProductDetail(String code, int qtyOnHand, double sellingPrice, double showPrice, double buyingPrice, String barcode, int productCode, boolean discountAvailability) {
        this.code = code;
